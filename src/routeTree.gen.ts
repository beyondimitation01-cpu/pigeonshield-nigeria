...
// Keep it in sync with files under src/routes; regenerate with the project's
// TanStack Router tooling when available.
...
const rootRouteChildren: RootRouteChildren = {
  IndexRoute,
  BreederDashboardRoute,
  FeedbackRoute,
  HowEscrowWorksRoute,
  McpRoute,
  MessagesRoute,
  MyOrdersRoute,
  PigeonBossAdminRoute,
